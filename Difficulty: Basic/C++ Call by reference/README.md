<h2><a href="https://www.geeksforgeeks.org/problems/c-call-by-reference/1">C++ Call by reference</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Given two positive integers <strong>a</strong> and<strong> b</strong>, <strong>reverse</strong> their<strong> </strong>digits and then <strong>swap</strong> them.</span></p>
